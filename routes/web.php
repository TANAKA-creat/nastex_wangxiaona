...
Route::post('/posts/{post}/return_comments',[ReturnCommentController::class,'store'])
->name('return_comments.store')
->where('post','[0-9]+');

Route::delete('/return_comments/{return_comment}/destroy',[ReturnCommentController::class,'destroy'])
